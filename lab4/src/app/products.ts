...
export const products = [
  ...
  {
    id: 4,
    name: 'Asyl Ui Dake 300x60x85 ЛДСП',
    price: 25000,
    description: 'Grat design.',
    image: 'https://resources.cdn-kaspi.kz/medias/sys_master/images/images/ha4/hfa/62384701243422/asyl-ui-dake-brend-300x60x85-ldsp-106405113-1.jpg',
    rating: 3.9,
    category: 'Компьютеры',
    likes: 0,  },
  {
  ...
  {
    id: 8,
    name: 'Стул ZETA C06 ВИ, 80x46x40 см, черный',
    price: 6999,
    description: 'Very comofortable and beautiful design',
    image: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h2f/h6f/66068340441118/zeta-c06-vi-chernyi-101748163-1.jpg',
    rating: 2.2,
    category: 'Компьютеры',
    likes: 0,  },
  {
  ...
  {
    id: 11,
    name: 'Этажерка для обуви RH 6015, 60x23x73, черный',
    price: 2200,
    description: 'Very comfortable and compact',
    image: 'https://resources.cdn-kaspi.kz/medias/sys_master/images/images/hc0/h88/66809567379486/napol-naya-polka-dlya-obuvi-rh6015-107971398-1.jpg',
    rating: 4.8,
    category: 'Компьютеры',
    likes: 0,    
  },
  {
    id: 12,
    name: 'CICADA Махаон 180х225 серый',
    price: 350000,
    description: 'Very soft bed',
    image: 'https://resources.cdn-kaspi.kz/img/m/p/h30/h31/64297021046814.jpg?format=preview-medium',
    rating: 3.2,
    category: 'Компьютеры',
    likes: 0,  },
  {
    id: 13,
    name: 'Artel ART 0860 PRIMA ECO черный',
    price: 24990,
    description: 'The chimney hood ARTEL ART-0860 Prima Eco has an original design, due to which it will harmoniously complement the interior in the loft style..',
    image: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h8f/h72/32988965634078/artel-art-0860-prima-eco-cernyj-100697482-1-Container.jpg',
    rating: 4.4,
    category: 'Бытовая техника',
    likes: 0,    
  },
  {
    id: 14,
    name: 'Стиральная машина LG F2V5GG2S серый',
    price: 370000,
    description: 'Smart care of your clothes AI DD (Artificial Intelligence) technology selects a variety of washing modes for your laundry, recognizing not only the weight, but also the type of fabric.',
    image: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h78/h52/61690908278814/lg-f2v5gg2s-seryj-100509545-1-Container.jpg',
    rating: 4.3,
    category: 'Бытовая техника',
    likes: 0,    
  },
  {
    id: 15,
    name: 'Samsung Galaxy S23 Ultra 5G 12 ГБ/1024 ГБ черный + подарок',
    price: 460000,
    description: 'Cool phonr with the best zoom in the world',
    image: 'https://resources.cdn-kaspi.kz/img/m/p/hef/hd6/68538934919198.jpg?format=preview-medium',
    rating: 4.7,
    category: 'Компьютеры',
    likes: 0,    
  },
  {
    id: 16,
    name: 'рация Baofeng UV-5R 5W',
    price: 11000,
    description: 'Works great for long distances',
    image: 'https://resources.cdn-kaspi.kz/medias/sys_master/images/images/h63/haa/33975968694302/baofeng-uv-5r-5w-cernyj-101416154-1-Container.jpg',
    rating:4.0,
    category: 'Гаджеты',
    likes: 0,    
  },
  {
    id: 17,
    name: 'X-Game XGH-1101 серый',
    price: 20000,
    description: 'A docking station is a device that allows you to turn your laptop into a desktop computer.',
    image: 'https://resources.cdn-kaspi.kz/img/m/p/h47/h11/64090407731230.jpg?format=preview-medium',
    rating: 3.2,
    category: 'Компьютеры',
    likes: 0,    
  },
  {
    id: 18,
    name: 'Моноблок Lenovo IdeaCentre AIO 3 27ALC6 F0FY00FDRU черный',
    price: 322000,
    description: 'Natural materials such as 6 recycled plastic trash and 7 recycled ocean plastic are used in the construction of this all-in-one case.',
    image: 'https://resources.cdn-kaspi.kz/medias/sys_master/images/images/h00/h3f/68183500161054/monoblok-lenovo-ideacentre-aio-3-27alc6-black-f0fy00fdru-108560531-1.jpg',
    rating: 4.2,
    category: 'Компьютеры',
    likes: 0,    
  },
  {
    id: 19,
    name: 'Монитор LG 32UN500-W серебристый',
    price: 160000,
    description: 'Quality monitor',
    image: "https://resources.cdn-kaspi.kz/img/m/p/h16/hc2/64920646549534.jpg?format=preview-medium",
    rating: 5,
    category: 'Компьютеры',
    likes: 0,    
  },
  {
    id: 20,
    name: 'Apple Magic Mouse 2 (USB-C) черный',
    price: 460000,
    ...
    image: 'https://resources.cdn-kaspi.kz/img/m/p/ha4/h07/64375097262110.jpg?format=preview-medium',
    rating: 2.9,
    category: 'Компьютеры',
    likes: 0,
  },
